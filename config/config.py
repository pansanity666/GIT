class Config():
    def __init__(self):
        ...
        self.BATCHSIZE = 48
        self.NUM_IMG_PER_ID = 3

        # model
        self.INPUT_SIZE = [256, 128]  # HxW
        self.MODEL_NAME = "resnet_ibn_a"  #resnet_ibn_a
        self.LAST_STRIDE = 1
        self.PRETRAIN_PATH = "/xxx/pretrained_model/resnet50-19c8e357.pth"
        self.MODEL_NECK = 'bnneck'  # 'bnneck' / 'no'
        ...
        # loss
        self.LOSS_TYPE = 'triplet+softmax+center'  # option: 'triplet+softmax','softmax+center','triplet+softmax+center'
        self.LOSS_LABELSMOOTH = 'on'  # option: 'on'
